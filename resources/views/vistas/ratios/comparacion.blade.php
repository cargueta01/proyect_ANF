                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        @if ($sector->razon_circulante < $comparacion['razon_circulante'])
                                            <td style="color:black"class="table-success">{{$comparacion['razon_circulante']}}</td>
                                        @elseif ($sector->razon_circulante > $comparacion['razon_circulante'])
                                            <td style="color:black"class="table-danger">{{$comparacion['razon_circulante']}}</td>
                                        @else
                                            <td>{{$comparacion['razon_circulante']}}</td>
                                        @endif    
                                        @endforeach
                                        <td style="color:black"class="table-info">{{$sector->razon_circulante}}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        @if ($sector->prueba_acida < $comparacion['prueba_acida'])
                                            <td style="color:black"class="table-success">{{$comparacion['prueba_acida']}}</td>
                                        @elseif ($sector->prueba_acida > $comparacion['prueba_acida'])
                                            <td style="color:black"class="table-danger">{{$comparacion['prueba_acida']}}</td>
                                        @else
                                            <td>{{$comparacion['prueba_acida']}}</td>
                                        @endif    
                                        @endforeach
                                        <td style="color:black"class="table-info">{{$sector->prueba_acida}}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        @if ($sector->rotacion_inventario < $comparacion['rotacion_inventario'])
                                            <td style="color:black"class="table-success">{{$comparacion['rotacion_inventario']}}</td>
                                        @elseif ($sector->rotacion_inventario > $comparacion['rotacion_inventario'])
                                            <td style="color:black"class="table-danger">{{$comparacion['rotacion_inventario']}}</td>
                                        @else
                                            <td>{{$comparacion['rotacion_inventario']}}</td>
                                        @endif    
                                        @endforeach
                                        <td style="color:black"class="table-info">{{$sector->rotacion_inventario}}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        @if ($sector->rotacion_cuentas_por_cobrar > $comparacion['rotacion_cuentas_por_cobrar'])
                                            <td style="color:black"class="table-success">{{$comparacion['rotacion_cuentas_por_cobrar']}}</td>
                                        @elseif ($sector->rotacion_cuentas_por_cobrar < $comparacion['rotacion_cuentas_por_cobrar'])
                                            <td style="color:black"class="table-danger">{{$comparacion['rotacion_cuentas_por_cobrar']}}</td>
                                        @else
                                            <td>{{$comparacion['rotacion_cuentas_por_cobrar']}}</td>
                                        @endif    
                                        @endforeach
                                        <td style="color:black"class="table-info">{{$sector->rotacion_cuentas_por_cobrar}}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        @if ($sector->grado_endeudamiento > $comparacion['grado_endeudamiento'])
                                            <td style="color:black"class="table-success">{{$comparacion['grado_endeudamiento']}}</td>
                                        @elseif ($sector->grado_endeudamiento < $comparacion['grado_endeudamiento'])
                                            <td style="color:black"class="table-danger">{{$comparacion['grado_endeudamiento']}}</td>
                                        @else
                                            <td>{{$comparacion['grado_endeudamiento']}}</td>
                                        @endif    
                                        @endforeach
                                        <td style="color:black"class="table-info">{{$sector->grado_endeudamiento}}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        @if ($sector->razon_endeudamiento_patrimonial > $comparacion['razon_endeudamiento_patrimonial'])
                                            <td style="color:black"class="table-success">{{$comparacion['razon_endeudamiento_patrimonial']}}</td>
                                        @elseif ($sector->razon_endeudamiento_patrimonial < $comparacion['razon_endeudamiento_patrimonial'])
                                            <td style="color:black"class="table-danger">{{$comparacion['razon_endeudamiento_patrimonial']}}</td>
                                        @else
                                            <td>{{$comparacion['razon_endeudamiento_patrimonial']}}</td>
                                        @endif    
                                        @endforeach
                                        <td style="color:black"class="table-info">{{$sector->razon_endeudamiento_patrimonial}}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        @if ($sector->rentabilidad_neta_del_patrimonio < $comparacion['rentabilidad_neta_del_patrimonio'])
                                            <td style="color:black"class="table-success">{{$comparacion['rentabilidad_neta_del_patrimonio']}}</td>
                                        @elseif ($sector->rentabilidad_neta_del_patrimonio > $comparacion['rentabilidad_neta_del_patrimonio'])
                                            <td style="color:black"class="table-danger">{{$comparacion['rentabilidad_neta_del_patrimonio']}}</td>
                                        @else
                                            <td>{{$comparacion['rentabilidad_neta_del_patrimonio']}}</td>
                                        @endif    
                                        @endforeach
                                        <td style="color:black"class="table-info">{{$sector->rentabilidad_neta_del_patrimonio}}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        @if ($sector->rentabilidad_del_activo < $comparacion['rentabilidad_del_activo'])
                                            <td style="color:black"class="table-success">{{$comparacion['rentabilidad_del_activo']}}</td>
                                        @elseif ($sector->rentabilidad_del_activo > $comparacion['rentabilidad_del_activo'])
                                            <td style="color:black"class="table-danger">{{$comparacion['rentabilidad_del_activo']}}</td>
                                        @else
                                            <td>{{$comparacion['rentabilidad_del_activo']}}</td>
                                        @endif    
                                        @endforeach
                                        <td style="color:black"class="table-info">{{$sector->rentabilidad_del_activo}}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        @if ($sector->rentabilidad_sobre_venta < $comparacion['rentabilidad_sobre_venta'])
                                            <td style="color:black"class="table-success">{{$comparacion['rentabilidad_sobre_venta']}}</td>
                                        @elseif ($sector->rentabilidad_sobre_venta > $comparacion['rentabilidad_sobre_venta'])
                                            <td style="color:black"class="table-danger">{{$comparacion['rentabilidad_sobre_venta']}}</td>
                                        @else
                                            <td>{{$comparacion['rentabilidad_sobre_venta']}}</td>
                                        @endif    
                                        @endforeach
                                        <td style="color:black"class="table-info">{{$sector->rentabilidad_sobre_venta}}</td>
                                    </tr>
